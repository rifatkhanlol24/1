...
export const INITIAL_USERS: User[] = [
  ...
  },
  {
    ...
    fullName: 'সারাহ রহমান (Sarah Rahman)',
    fullNameBn: 'সারাহ রহমান',
    fullNameEn: 'Sarah Rahman',
    ...
    bioBn: 'ফটোগ্রাফার ও ভিজ্যুয়াল স্টোরিটেলার। প্রকৃতির প্রতিটি রঙের মুগ্ধতা ক্যামেরাবন্দী করি 📷✨',
  ...
  },
  {
    ...
    fullNameBn: 'তানভীর আহমেদ',
    fullNameEn: 'Tanvir Ahmed',
    ...
    bioBn: 'ফুলস্ট্যাক সফটওয়্যার ইঞ্জিনিয়ার। কোডিং, ওপেন সোর্স ও এআই প্রযুক্তিপ্রেমী 💻⚡',
  ...
  },
  {
    ...
    username: 'maya_nomad',
    fullName: 'মায়া চৌধুরী (Maya Chowdhury)',
    fullNameBn: 'মায়া চৌধুরী',
    fullNameEn: 'Maya Chowdhury',
    ...
    bioBn: 'পাহাড় ও সমুদ্রের পর্যটক ☕ বিশ্বের মনোরম স্থানগুলো ঘুরে দেখার নেশা।',
  ...
  },
  {
    ...
    fullName: 'আরমান হোসেন (Arman Hossain)',
    fullNameBn: 'আরমান হোসেন',
    fullNameEn: 'Arman Hossain',
    ...
    bioBn: 'ডিজিটাল আর্টিস্ট ও ইউজার ইন্টারফেস ডিজাইনার। রঙের জাদুতে পিক্সেল সাজাই 🎨',
    location: 'Dhaka, Bangladesh',
