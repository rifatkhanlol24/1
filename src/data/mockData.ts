...
export const INITIAL_USERS: User[] = [
  {
    id: 'user-admin',
    email: 'rifatkhanlol24@gmail.com',
    password: 'password123',
    username: 'rifat_admin',
    usernameChangeCount: 0,
    fullName: 'Rifat Khan (Admin)',
    ...
    website: 'https://github.com/rifatkhan',
    links: [
      { id: 'l-1', title: 'GitHub Portfolio', url: 'https://github.com/rifatkhan' },
      { id: 'l-2', title: 'Tech Blog', url: 'https://techlystb.blogspot.com' },
      { id: 'l-3', title: 'LinkedIn Profile', url: 'https://linkedin.com/in/rifatkhan' },
    ],
