            ...
            <div className="rounded-3xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-2xl p-6 sm:p-8 space-y-5">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-0.5">
                  {mode === 'login' && (lang === 'bn' ? 'Google অথবা ইমেইল দিয়ে লগইন সম্পন্ন করুন।' : 'Login with Google or email to access your account.')}
                  {mode === 'register' && (lang === 'bn' ? 'Google দিয়ে তাৎক্ষণিক বা ১ মিনিটে ফর্ম পূরণ করুন।' : 'Join instantly with Google or complete the quick form.')}
              ...
              {mode !== 'forgot' && (
                <div className="space-y-3 pt-1">
                  <button
                    ...
                    className="w-full py-3 px-4 rounded-2xl bg-white dark:bg-neutral-800 hover:bg-neutral-50 dark:hover:bg-neutral-750 text-neutral-800 dark:text-neutral-100 font-bold text-xs border border-neutral-300 dark:border-neutral-700 shadow-sm hover:shadow-md flex items-center justify-center gap-3 transition-all disabled:opacity-60 cursor-pointer"
                  >
                    {isGoogleLoading ? (
